...
def load_and_cache_examples(args, tokenizer, labels, mode='train'):
    ...
    if os.path.exists(cached_features_file) and not args.overwrite_cache:
        ...
        # I added this line 
        print("This is the len of instances:", len(instances))
        print("This is the len of features:", len(features)) 
        if args.local_rank in [-1, 0]:
...
def main():
    ...
    if args.do_train:
        ...
        print("This is the dataset len:", len(train_dataset))
    ...
    if args.do_predict and args.local_rank in [-1, 0]:
        ...
        with open(output_test_predictions_file, "w", encoding='utf-8') as writer:
            ...
            for i in range(N):
                ...
                # uncommente the lines below if your dataset does not have headlines
            '''
            ...
            for l, line in enumerate(line_data):
                if l == 0:
                    ...
                    index_id, label, text = line.strip().split("\t")
